...
public class Tbiodata extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            {
             String query="INSERT INTO teacherinfo (id,name,department,qualification,number,gender,address,password,con_password) VALUES('"+id+"','"+name+"','"+dept+"','"+qual+"',"+num+",'"+gender+"','"+add+"','"+pass+"','"+conpass+"')";
